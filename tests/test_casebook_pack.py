"""Regression checks for the grammark casebook."""
...
from casebook.harness import assert_expected, grammark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(grammark_summary(), assert_expected())
