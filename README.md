...
grammark is a JavaScript project for developer tools. It focuses on this technical goal: Validate EBNF fragments and compute FIRST-set diagnostics.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 181, risk penalty 4, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
